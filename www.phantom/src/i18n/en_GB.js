const en_GB = {
    ...
    cancel: "Cancel",
    select_domain: "Please select a domain from the list above to begin editing your website",
    no_domains: "You currently have no domains registered to this machine, please click \"create domain\" to get started",
    no_posts: "You currently have no Posts, please click \"create post\" to get started",
    no_pages: "You currently have no Pages, please click \"Create page\" to get started",
    title: "Title",
    status: "Status",
    ...
    unpublished_drafts_help: "To release a new version of your blog including all unpublished drafts click \"Publish drafts\" at the top right.",
